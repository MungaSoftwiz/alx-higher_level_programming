...
In this project, I discovered how to bring in and apply functions, as well as
make modules in Python. I also got more experience with the built-in function
`dir()` and worked with command line arguments in Python programs.
