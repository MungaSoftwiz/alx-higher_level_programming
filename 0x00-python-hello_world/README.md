...
This directory contains projects that demonstrate my understanding of 
how to use the Python interpreter, printing words and numbers, 
and working with text in Python.
...
* **13. ByteCode -> Python #1**
  * [102-magic_calculation.py](./103-magic_calculation.py): Python function matching exactly
  a bytecode provided by ALX Africa.
